...
ECKey eckPub = ECKey.fromPublicOnly(hex2Byte(senderPublicKey));
eckPub = eckPub.decompress();
senderPublicKey = eckPub.getPublicKeyAsHex();
out.println("<p>new senderPublicKey=" + senderPublicKey);
...
BigInteger gasLimit = BigInteger.valueOf(2000000);
String to = "0x65D28726cFA311F80e2C02608185C9900861aad7";
BigInteger value = BigInteger.valueOf(1);

RawTransaction rawTransaction  = RawTransaction.createEtherTransaction(nonce, gasPrice, gasLimit, to, value);
byte[] encodedTransaction = TransactionEncoder.encode(rawTransaction, (long) 3);
byte[] messageHash = Hash.sha3(encodedTransaction);	//須被簽名的資料
out.println("<p>messageHash=" + byte2Hex(messageHash));
String sSignatureData = "30440220277BF671200C95B99E5B3BF01C4B3B07E0D26803BF94A10713653D6D10805B4B0220197211EE7A9DC45FCAF1EDF7787C8E681BD84D88ED9C790FDA4C38680C6F73FE";
...
out.println("<p>hexValue signed transactionHash=" + hexValue);
EthSendTransaction ethSendTransaction = web3j.ethSendRawTransaction(hexValue).sendAsync().get();
String transactionHashId = ethSendTransaction.getTransactionHash();

out.println("<p>transactionHashId=" + transactionHashId);
