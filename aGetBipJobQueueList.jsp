...
//取得BIP job queue清單
sSQL = "SELECT id, DATE_FORMAT(Create_Date, '%Y-%m-%d %H:%i') AS Create_Date, Job_Description, Job_Type, Card_Id, Transaction_Id, Wallet_Id, Wallet_Name, Currency_Id, Status";
...
String[] fields = {"id", "Create_Date", "Job_Description", "Job_Type", "Card_Id", "Transaction_Id", "Wallet_Id", "Wallet_Name", "Currency_Id", "Status"};
