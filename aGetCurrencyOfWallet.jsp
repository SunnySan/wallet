...
if (beEmpty(appId) || appId.length()!=16 || beEmpty(cardId) || cardId.length()!=16 ||  beEmpty(walletId)){
...
//取得Currency清單
sSQL = "SELECT A.id, A.Currency_Id, B.Currency_Name, A.Publicy_Key, A.Address";
...
String[] fields = {"id", "Currency_Id", "Currency_Name", "Publicy_Key", "Address"};
