...
(function () {
	...
	*/
	...
	coinjs.wif2privkey = function(wif){
		...
		console.log("Crypto.util.bytesToHex(key)= " + Crypto.util.bytesToHex(key));
	...
	coinjs.addressDecode = function(addr){
		try {
			...
			if (checksum+"" == back+"") {
				...
				} else if (o.version==coinjs.pubtest) { // standard address (Testnet)
					o.type = 'standardtest';
