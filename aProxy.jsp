...
String	sResponse	= "";
/*********************開始做事吧*********************/
String sUrl		= nullToString(request.getParameter("u"), "");
//String sUrl		= "";
//if (notEmpty(sUrl)) sUrl = new String(hex2Byte(sUrl), "UTF-8");
if (notEmpty(sUrl)) sUrl = new String(hex2Byte(sUrl));
writeLog("debug", "sUrl= " + sUrl);
InputStream	is			= null;
String		contentStr	= "";

writeLog("debug", "Get data from URL: " + sUrl);
//sUrl = "https://testnet.blockchain.info/balance?active=mjDsHBSbwouL1H8fzp7onN2BcC1rWLobGZ";
	try{
		URL u;
		u = new URL(sUrl);
		...
		writeLog("error", "Exception when get data from URL: " + sUrl + ", error= " + e.toString());
	}
