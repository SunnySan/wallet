...
ECKey.ECDSASignature sig = ECKey.ECDSASignature.decodeFromDER(hex2Byte(sSignatureData)).toCanonicalised();

ECKey pubKey = ECKey.fromPublicOnly(hex2Byte(senderPublicKey));
//ECKey decompressedPubKey = pubKey.decompress();
        // Now we have to work backwards to figure out the recId needed to recover the signature.
        int recId = -1;
        //byte[] thisKey = this.pub.getEncoded(/* compressed */ false);
        byte[] thisKey = pubKey.getPubKey();
